...
namedRouter.post("user.testimonialdatstore", '/testimonialdatastore', authCheck, userController.testimonial)

namedRouter.get("user.testimonialdatashow", '/testimonialdatashow/:id', authCheck, userController.testimonialshow)
